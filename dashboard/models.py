...
class Blog(models.Model):
    ...
    photo1 = models.FileField( upload_to='photos/%Y/%m/%d/', default=None, null=True, blank=True)
    photo2 = models.FileField( upload_to='photos/%Y/%m/%d/', default=None, null=True, blank=True)
    photo3 = models.FileField( upload_to='photos/%Y/%m/%d/', default=None, null=True, blank=True)
    photo4 = models.FileField( upload_to='photos/%Y/%m/%d/', default=None, null=True, blank=True)
    photo5 = models.FileField( upload_to='photos/%Y/%m/%d/', default=None, null=True, blank=True)
