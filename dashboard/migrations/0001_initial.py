...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0003_customuser_organe'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to='photos/%Y/%m/%d/')),
                ('text', ckeditor.fields.RichTextField(blank=True, default=False, null=True)),
                ('statut', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.TextField(blank=True, null=True)),
                ('created_date', models.DateField(auto_now_add=True)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='demandes', to='accounts.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Personne',
            fields=[
                ...
                ('demande', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.demande')),
            ],
        ),
    ]
