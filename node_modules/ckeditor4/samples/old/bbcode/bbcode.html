		...
		<p>
			...
			<script>
				...
				CKEDITOR.replace( 'editor1', {
					...
					removePlugins: 'bidi,dialogadvtab,div,filebrowser,format,forms,horizontalrule,iframe,justify,liststyle,pagebreak,showborders,stylescombo,table,tabletools,templates',
